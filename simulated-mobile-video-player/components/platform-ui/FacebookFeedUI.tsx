...
export const FacebookFeedUI: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <div className="h-full bg-[#242526] text-[#E4E6EB] overflow-y-auto">
        <div className="bg-[#242526] py-3">
            <div className="px-3">
                ...
                <p className="text-sm my-2 px-1">Having a great time with this new app! It's so cool, you should definitely check it out.</p>
            </div>
            ...
            <div className="px-3 mt-2">
                ...
                <div className="flex justify-around items-center text-gray-400 font-semibold text-sm">
                    <button className="flex-1 text-center py-1 rounded-md hover:bg-gray-700">👍 Like</button>
                    <button className="flex-1 text-center py-1 rounded-md hover:bg-gray-700">💬 Comment</button>
                    <button className="flex-1 text-center py-1 rounded-md hover:bg-gray-700">➤ Share</button>
                </div>
            </div>
        </div>
    </div>
