      ...
      <div className="max-w-screen-2xl mx-auto">
        <header className="text-center mb-10 md:mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
            An interactive tool to visualize how vertical videos are displayed
            across different social media platforms. Select a platform to see
            its specific UI and rendering characteristics.
          </p>
        </header>
