...
export function SocialPlatformsCarousel() {
  const platforms = [
    {
      name: "YouTube",
      icon: (
        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#FF0000">
    ...
    },
    {
      name: "Instagram",
      icon: (
        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#E4405F">
    ...
    },
    {
      name: "TikTok",
      icon: (
        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#000000">
    ...
    },
    {
      name: "LinkedIn",
      icon: (
        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#0077B5">
    ...
    },
    {
      name: "Twitter",
      icon: (
        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#1DA1F2">
    ...
    },
    {
      name: "Snapchat",
      icon: (
        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#FFFC00">
    ...
    },
    {
      name: "Pinterest",
      icon: (
        <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#BD081C">
  ...
  return (
    <section className="bg-background overflow-hidden pt-8 pb-16 md:pt-10 md:pb-16">
          ...
          <div className="relative py-6 md:w-[calc(100%-11rem)]">
            <InfiniteSlider speedOnHover={20} speed={40} gap={112}>
              {platforms.map((platform, index) => (
                <div key={`${platform.name}-${index}`} className="flex">
            ...
            <div className="from-background absolute inset-y-0 left-0 w-20 bg-gradient-to-r"></div>
            <div className="from-background absolute inset-y-0 right-0 w-20 bg-gradient-to-l"></div>
            <ProgressiveBlur
